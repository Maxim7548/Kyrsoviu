...
namespace Автосервіс
{
    public partial class mainForm : MetroForm
    {
        ...
        private void EnableButtons()
        {
            ...
            metroButtonGiveAct.Enabled = true;
            metroButtonWriteoffAct.Enabled = true;
        }
        private void HidePanels()
        {
            ...
            metroPanelInstrumentWorkers.Visible = false;
        }
 ...
 **/
        ...
        private void metroButtonInstrumentWorkers_Click(object sender, EventArgs e)
        {
            HidePanels();
            EnableButtons();
            metroPanelInstrumentWorkers.Visible = true;
            metroPanelInstrumentWorkers.Focus();
            metroButtonInstrumentWorkers.Enabled = false;
        }
